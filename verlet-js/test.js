...
window.onload = function() {
	...
	// simulation
	var sim = new VerletJS(width, height, canvas); // VerletJS = function(width, height, canvas)			
	// entities
	var pool = sim.pool(new Vec2(500,500) );
	pool.drawParticles = function( ctx,composite) // The ctx=getContext() method returns an object that provides methods and properties for drawing on the canvas.				
	{
	// Draw the pools.				
